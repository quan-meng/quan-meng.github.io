...
\begin{enumerate} 
	...
	We introduce GNeRF, a method that can estimate camera poses and neural radiance fields jointly when the cameras are initialized at random poses in complex scenarios (outside-in scenes, even with less texture or intense noise ). We achieve this by marrying Generative Adversarial Networks (GAN) with Neural Radiance Field.
...
\vspace{-0.25in}
\begin{outerlist}
\item First prices in \href{http://www.worldrobotconference.com/en/}{World Robot Contest Fighting Robot Competition}. \hfill 2017
\item First prices (Shan Dong) in \href{https://www.nuedc-training.com.cn/}{National Undergraduate Electronics Design Contest} \hfill 2017, 2018
\item National Scholarship Award	 \hfill 2021
...
\vspace{-0.25in}
\begin{outerlist}
	\item {\it Programming}: Linux, C/C++, Python, Java, Pytorch, Opencv, Latex, Matlab, Qt.
	\item {\it Hardwares}: Circuit Design, ARM, STM32, STC, PCB. 
	\item {\it Softwares}: Blender, Keil, Illustrator
\end{outerlist}
...
\vspace{-0.25in}
\begin{outerlist}
	\item {\it CS280 Deep Learning} in ShanghaiTech University: Teaching Assistant
\end{outerlist}
