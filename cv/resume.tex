...
\makeheading{Quan Meng \hfill {\small Last update: \today}}
...
\texttt{Address}: Garching, Munich, Germany & \\
{\faWechat} \texttt{Wechat}: nenhabkks   & {\faMousePointer} \texttt{Homepage:}\href{https://quan-meng.github.io}{https://quan-meng.github.io}\\
{\large\faMobile} \texttt{Tel:} +49 17685971811     &  {\faEnvelopeO} \texttt{E-mail:}\href{mailto:mengquan@shanghaitech.edu.cn}{mengquan@shanghaitech.edu.cn}\\
\end{tabular}


%% ========= Academic History ==============================
\section{Academic History}
\href{https://www.tum.de/en/}{\textbf{Technical University of Munich}} \hfill Fall 2022 - Now
\begin{outerlist}
	\item PhD candidate in Computer Science and Engineering
	\item Advisor: Prof. \href{https://www.3dunderstanding.org}{Angela Dai}
\end{outerlist}

\vspace{0.1in}
\href{https://www.shanghaitech.edu.cn/eng/}{\textbf{ShanghaiTech University}} \hfill Fall 2019 - Spring 2022
\begin{outerlist}
...
\begin{enumerate} 
	...
	{\bf GNeRF: GAN-Based Neural Radiance Field without Posed Camera} \\
	...
	{\bf LGNN: A Context-Aware Line Segment Detector} \\
...
\vspace{-0.25in}
\begin{outerlist}
\item First prize in Macrochip Cup Microcontroller Application Technology Competition \hfill 2017
...
\vspace{-0.25in}
\begin{outerlist}
	\item CS280 Deep Learning in ShanghaiTech University: Teaching Assistant \hfill Fall 2020
\end{outerlist}
...
\vspace{-0.25in}
\begin{outerlist}
	\item Programming: Linux, Python, C/C++, Pytorch, , Assembly Language (ARM), Java, Opencv, Latex, Matlab, Qt.
	\item Softwares: Blender, MeshLab, Illustrator, Keil
